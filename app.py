...
#=== [SEGAME TEAM] ===
    ...
    elif (text == "!SeGame MLBB Team") or (text == "SeGame MLBB Team") or (text == "Segame mlbb team") or (text == "segame mlbb team"):
        token = event.reply_token
        message = TemplateSendMessage(
            alt_text = "SeGame Mobile Legend Team",
            template = CarouselColumn(
                columns = [
                    CarouselColumn(
                        thumbnail_image_url = "https://i.pinimg.com/originals/a5/60/66/a5606644ca6415e4a093ae821b3f09ce.png",
                        title = "Next Generation",
                        text = "Klik dibawah ini untuk informasi team kami",
                        actions = [
                            MessageTemplateAction(
                                label = "Informasi Team",
    ...
    elif (text == "!next generation team") or (text == "!team 2") or (text == "!hunger strike team"):
...
#=====[ CAROUSEL MESSAGE ]==========
        ...
        message = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        thumbnail_image_url='https://i.ibb.co/VjWfQky/yunaldi.jpg',
